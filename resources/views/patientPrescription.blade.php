<!-- This view is responsible for showing a patient his prescription for a respective appointment  -->

@extends('ptDashBrd') <!-- Extending the patient dashboard layout -->

@section('content') <!-- Section to be injected as content into the .mn div -->
...
<div class="prcp">
    ...
    <div class="prescription">
        <!-- Created a div container with the class 'prescription' to style and group the prescription content -->
